...
# Beginning of script
{
  ...
  ui <- #secure_app( #uncomment if needing password protection
    ...
    p(
     ...
     p(
      HTML(paste0('A more detailed breakdown of these data is available in the <b> <a href="https://publichealthscotland.scot/publications/drug-related-hospital-statistics/drug-related-hospital-statistics-scotland-2020-to-2021/data-eplorer">Data explorer</a></b>.'))
      ) ,
    p(
      "Technical terms are explained in the ", 
          HTML(paste0('<b><a href="https://publichealthscotland.scot/publications/drug-related-hospital-statistics/drug-related-hospital-statistics-scotland-2020-to-2021/glossary">Glossary</a></b>.'))
    ),
    p(
    ...
    p(
      ...
      tags$ul(
        tags$li("After a greater than threefold increase in the rate of drug-related hospital stays in Scotland between 1996/97 and 2019/20, 
                there was a drop from 284 stays per 100,000 population in 2019/20 to 270 stays per 100,000 population in 2020/21."),
        tags$li("The rate of drug-related general acute hospital stays increased from 51 to 245 stays 
                per 100,000 population between 1996/97 and 2019/20, but fell in 2020/21 to 235 stays per 100,000 population in 2020/21."),
        tags$li("The rate of drug-related psychiatric hospital stays in Scotland between 2015/16 and 2019/20 was between 36 and 41 stays per population, 
                but has fallen in 2020/21 to 34 stays per 100,000 population."),
        tags$li("The drug-related new patient rate
                increased from 55 new patients per 100,000 population in 2006/07 to 104 new patients per 100,000 population in 2019/20, 
                and then dropped in 2020/21 to 97 per 100,000 population.")
      )),
      tags$a(href = '#Top',  
    ...
    p(
      ...
      p("Main points (Scotland)",
      tags$ul(
        tags$li("In 2020/21, there were 127 stays per 100,000 population associated with opioids in
                Scottish hospitals (general acute or psychiatric). The next most common drug types recorded
                in hospital stays were multiple/other drugs (61 stays per 100,000 population), sedatives/hypnotics (54),
                cannabinoids (40) and cocaine (33)."),
        tags$li("In 2020/21, opioids (drugs similar to heroin) were associated with 50% of drug-related general acute
                ...
                2014/15 and 2020/21, the percentage of drug-related general acute stays associated with sedatives/hypnotics
                increased from 8% to 21%."),
        tags$li("In 2020/21, over half (51%) of drug-related psychiatric stays in Scotland were associated with
      ...
      p(
        ...
        tags$ul(
          tags$li("Since 2013/14, the most common age group among people with a drug-related hospital stay 
                  (general acute or psychiatric) has been 35-44 years. After a ninefold increase in patient rates between 1996/97 
                  and 2019/20, rates fell from 517 patients per 100,000 population in 2019/20 to 474 patients per 100,000 in 2020/21."),
          tags$li("Following a lengthy period of annual decreases, patient rates for 15-24 year olds 
                  ...
                  in 2019/20, before falling to 216 patients per 100,000 popluation in 2020/21."),
          tags$li("Between 1996/97 and 2020/21, drug-related patient rates for males were consistently 
                  more than double drug-related patient rates for females."),
          tags$li("In 2020/21, approximately half of the patients with a drug-related general acute 
    ...
    output$activity_summary_plot <- renderPlotly({
      ...
      plot_ly(
        ...
        layout(title = list(text=
                              paste0(  
                            " Drug-related hospital rates by activity type 1996/97 to 2020/21",
                            "<br>","(",
                            input$Location,
                            "; ",
                            input$Hospital_Type, "; ",
    ...
    output$drugs_plot <- renderPlotly({
      ...
      plot_ly(
        ...
        layout(title = list(
          text=
            paste0(  
                     "Drug-related hospital stay rates by drug type 1996/97 to 2020/21",
                     "<br>", " (",
                     input$Location,
                     "; ",
                     input$Hospital_Type,"; ",
